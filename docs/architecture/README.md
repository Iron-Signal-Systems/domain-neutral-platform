...
- [Project Status Registry](../project-status.json)
- [Repository Boundary Synchronization](foundation/repository-boundary-synchronization.md)
- [Module Family Repository Integration](foundation/module-family-repository-integration.md)
...
- [Phase 6 Step 2 Production Go Workspace and Build Baseline](backend-services/phase-6-step-2-production-go-workspace-and-build-baseline.md)
...
Step 8 requires a governed rebaseline. It adds hostile,
