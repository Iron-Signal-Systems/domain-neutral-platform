...
Foundation migrations occupy `000–099`. Later ranges are allocated only by separately governed Shared Resource, Module Families, adapter, and deployment/bootstrap decisions.
